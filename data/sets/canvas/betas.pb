...
cap { role: "grave"      text: "` ~"  size: U100  color: "lightgray" }
cap { role: "1"          text: "1 !"  size: U100  color: "lightgray" }
cap { role: "2"          text: "2 @"  size: U100  color: "lightgray" }
cap { role: "3"          text: "3 #"  size: U100  color: "lightgray" }
cap { role: "4"          text: "4 $"  size: U100  color: "lightgray" }
cap { role: "5"          text: "5 %"  size: U100  color: "lightgray" }
cap { role: "6"          text: "6 ^"  size: U100  color: "lightgray" }
cap { role: "7"          text: "7 &"  size: U100  color: "lightgray" }
cap { role: "8"          text: "8 *"  size: U100  color: "lightgray" }
cap { role: "9"          text: "9 ("  size: U100  color: "lightgray" }
cap { role: "0"          text: "0 )"  size: U100  color: "lightgray" }
cap { role: "minus"      text: "- _"  size: U100  color: "lightgray" }
cap { role: "equal"      text: "= +"  size: U100  color: "lightgray" }

# Q row.
cap { role: "backslash"  text: "\\ |" size: U150  color: "lightgray" }
cap { role: "backslash"  text: "\\ |" size: U100  color: "lightgray" }
...
# A row.
cap { role: "backslash"  text: "\\ |" size: U150  color: "gray" }
...
cap { role: "00"         text: "00"   size: U100  color: "lightgray" }
cap { role: "1"          text: "1"    size: U100  color: "lightgray" }
cap { role: "2"          text: "2"    size: U100  color: "lightgray" }
cap { role: "3"          text: "3"    size: U100  color: "lightgray" }

cap { role: "0"          text: "0"    size: U100  color: "lightgray" }
cap { role: "0"          text: "0"    size: U200  color: "lightgray" }
cap { role: "."          text: "."    size: U100  color: "lightgray" }
