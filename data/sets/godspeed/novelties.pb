...
cap { role: "enter"   glyph: "GODSPEED"    size: U225 color: "YCE" profile: SA row: R3 }
cap { role: "enter"   glyph: "GODSPEED"    size: U225 color: "BFJ" profile: SA row: R3 }
cap {                 glyph: "cospar"      size: U100 color: "BFJ" profile: SA row: R3 }
cap {                 glyph: "cospar"      size: U100 color: "BFJ" profile: SA row: R3 }

cap { role: "shift"   glyph: "DEFLECT"     size: U225 color: "BFJ" profile: SA row: R4 }
...
cap { role: "down"    glyph: "down-arrow"  size: U100 color: "BFJ" profile: SA row: R3 }
cap { role: "right"   glyph: "right-arrow" size: U100 color: "BFJ" profile: SA row: R3 }
